      ...
      <form className="bg-white rounded-md sm:w-full">
        <div className="flex sm:flex-col gap-5 px-5 w-[25rem] mb-[3rem] pt-2">
          <div className="flex flex-col w-full">
            <label htmlFor="NetworkProvider" className="text-[14px] font-semibold">
              Network Provider
            </label>
            
            <select name="network provider" id="" className="border border-gray-400 py-1.5 px-2.5 w-full text-[14px] font-semibold rounded-md">
              <option value="network provider" className="">Network Provider</option>
            </select>
